...
func AndroidMakeCode(P models.Project) {
	...
	buildAndroidModels(mainfolder, P.Objects, P.Db)
	buildAndroidControllers(mainfolder, P.Objects, P.Db)
}

func buildAndroidConnection(mainfolder string, P models.Project) {
...
func buildAndroidModels(mainfolder string, Objs []models.Object, db string) {
	for _, O := range Objs {
		buildAndroidModel(mainfolder, O, db)
	}
}

func buildAndroidControllers(mainfolder string, Objs []models.Object, db string) {
	for _, O := range Objs {
		buildAndroidController(mainfolder, O, db)
	}
}

func buildAndroidModel(mainfolder string, O models.Object, db string) {
...
func buildAndroidController(mainfolder string, O models.Object, db string) {
...
func strAndroidParams2(Cols []models.Column) string {
	strP := ""
	strP += "\t\t\t$data = [\n"
...
func strAndroidParams(Cols []models.Column) string {
	strP := "\t\t\t$data = array(\n"
...
func strAndroidLogin(O models.Object) string {
	strP := ""
...
func strAndroidInsert(O models.Object) string {
	strP := ""
...
func strAndroidUpdate(O models.Object) string {
	strP := ""
	strQ := ""
...
func strAndroidDelete(O models.Object) string {
	strP := ""
	strQ := ""
...
func strAndroidFindAll(O models.Object) string {
	strP := ""
	strQ := ""
	strP += "\t\t\t$sql = 'SELECT "
	strQ += "\t\t\t$stmt = $this->connection->prepare($sql);\n"
...
func strAndroidFindAllPag(O models.Object) string {
	strP := ""
	strQ := ""
	strP += "\t\t\t$sql = 'SELECT "
	strQ += "\t\t\t$stmt = $this->connection->prepare($sql);\n"
...
func strAndroidFindOne(O models.Object) string {
	strP := ""
	strQ := ""
	strP += "\t\t\t$sql = 'SELECT "
	strQ += "\t\t\t$stmt = $this->connection->prepare($sql);\n"
